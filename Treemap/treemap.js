...
let mouseover = (d,i)=>{
    toolTip.style("visibility","visible").html("$" + i.value+"<br>Category: "+i.data.category+"<br>Title: "+i.data.name+"<br>").attr("data-value",i.value).style("font","12px arial").style("color","darkblue").style("border","1px solid darkred").style("background-color", "papayawhip").style("left",0.5*w).style("top",0.5*h);}
